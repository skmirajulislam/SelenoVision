...
const LunarChatbot: React.FC<LunarChatbotProps> = ({ isOpen, onClose }) => {
  ...
  const saveApiKey = () => {
    if (apiKey.trim()) {
      Cookies.set('gemini_api_key', apiKey, { expires: 30 }); // 30 days
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 w-96 h-96">
      <Card className="w-full h-full bg-gradient-to-br from-indigo-950 via-purple-900 to-indigo-900 border-purple-400/20 shadow-2xl">
        <CardHeader className="p-3 border-b border-purple-400/20">
